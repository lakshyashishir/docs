...
description: "While the AgentTest backend exposes a clear and simple HTTP API for assigning variants and logging results, the most convenient way to integrate AgentTest into your AI agent applications will typically be through dedicated Software Development Kits (SDKs)."
---
